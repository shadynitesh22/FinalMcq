...
public class QuesForm extends JFrame implements ActionListener{
    ...
    public QuesForm(){
        ...
        cmbsubject.addItem("History");
        cmbsubject.addItem("Movies");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        {       
            if(cmbsubject.getSelectedItem()=="Java")
            {
             ...
             if(ae.getSource().equals(btnSave))
        {       
            if(cmbsubject.getSelectedItem()=="History")
            {
               if((question.getText().equals("") || ans1.getText().equals("") || ans2.getText().equals("") || ans3.getText().equals("") || ans4.getText().equals("") || CorrrectAns.getText().equals("")))
               {
                    JOptionPane.showMessageDialog(null, "Unable to Save");
                    ...
                    database db=new database();
                    int values=db.addHistory(question.getText(),ans1.getText(),ans2.getText(),ans3.getText(),ans4.getText(),CorrrectAns.getText());
                    if(values>0)
                    {
                        JOptionPane.showMessageDialog(null,"Sucessfully Added!!");
              ...
              if(ae.getSource().equals(btnSave))
        {       
            if(cmbsubject.getSelectedItem()=="Movie")
            {
               if((question.getText().equals("") || ans1.getText().equals("") || ans2.getText().equals("") || ans3.getText().equals("") || ans4.getText().equals("") || CorrrectAns.getText().equals("")))
               {
                    JOptionPane.showMessageDialog(null, "Unable to Save");
                    ...
                    database db=new database();
                    int values=db.addmovies(question.getText(),ans1.getText(),ans2.getText(),ans3.getText(),ans4.getText(),CorrrectAns.getText());
                    if(values>0)
                    {
                        JOptionPane.showMessageDialog(null,"Sucessfully Added!!");
