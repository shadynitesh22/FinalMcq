...
public class database {
     ...
     public int addqn(String Question,String Option1,String Option2,String Option3,String Option4, String CorrectAns)
    {
     ...
     public int addHistory(String Question,String Option1,String Option2,String Option3,String Option4, String CorrectAns)
    {
         int values=0;
        try {
            pstmt=con.prepareStatement("INSERT INTO `history`(`Question`, `Option1`, `Option2`, `Option3`, `Option4`, `CorrectAns`) VALUES (?,?,?,?,?,?)");
            pstmt.setString(1,Question);
            pstmt.setString(2,Option1);
            pstmt.setString(3,Option2);
            pstmt.setString(4,Option3);
      ...
      public int addmovies(String Question,String Option1,String Option2,String Option3,String Option4, String CorrectAns)
    {
         int values=0;
        try {
            pstmt=con.prepareStatement("INSERT INTO `movies`(`Question`, `Option1`, `Option2`, `Option3`, `Option4`, `CorrectAns`) VALUES (?,?,?,?,?,?)");
            pstmt.setString(1,Question);
            pstmt.setString(2,Option1);
            pstmt.setString(3,Option2);
            pstmt.setString(4,Option3);
    ...
    //public int save(String UserName,String Password)
    {
        int result=0;
        try {
            pstmt=con.prepareStatement("INSERT INTO `studentform`(`UserName`, `Password`, `Applier`) VALUES (?,?)");
            pstmt=con.prepareStatement("INSERT INTO `loginform`(`UserName`, `Password`) VALUES (?,?)");
            pstmt.setString(1,UserName);
            pstmt.setString(2,Password);
            
            String value=Applier.getBytes().toString();
